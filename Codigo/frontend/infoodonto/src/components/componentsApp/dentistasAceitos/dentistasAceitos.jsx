...
const DentistasAceitos = ({ aceitos, pacienteLogado }) =>{
    ...
    return(
        ...
        <h1 className={ styles.titulo }>Dentistas <br></br>aceitos</h1>
            ...
            <TableBody>
              { rows.map(row => (
                ...
                >
                  ...
                  <TableCell align='left'>{ row.dentista.user.email }</TableCell>
                  <TableCell align='left'>{ row.dentista.instituicao.name }</TableCell>
                  <TableCell>
                    <button
