...
function Input(props) {
    ...
    /* Exemplo de usos:
    Text: <Input type="text" placeholder="Exemplo" disabled={true} id="idTeste"></Input>
    ...
    */
    ...
    function returnType(){
        switch(props.type){
            case 'text': return (<InputText placeholder={props.placeholder} disabled={props.disabled} id={props.id}/>);
