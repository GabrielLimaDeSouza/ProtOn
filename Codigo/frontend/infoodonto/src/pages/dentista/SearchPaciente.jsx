  ...
  useEffect(() => {
    if (paciente != null && Object.keys(paciente).length !== 0) {
      ...
      paciente.condicoes.map((condicao) => {
        setPreAtendimento(preAtendimento.concat(condicao.preAtendimento));
        setAnestesicoLocal(anestesicoLocal.concat(condicao.anestesicoLocal));
        setMedicamentos(medicamentos.concat(condicao.medicamentos));
