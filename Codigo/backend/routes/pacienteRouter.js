...
router.route('/paciente/:id/dentistas').get((req, res) => pacienteController.dentistas(req, res))
...
router.route('/paciente/:cpf/dentistas').delete((req, res) => pacienteController.removerPermissao(req, res))
